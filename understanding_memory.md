...
## notes for the notes(kek)


## focusses of memory management
Extends physical memory limitations
Provides seamless memory experience
Optimizes resource utilization
Happens so quickly you never notice
